        ...
        <header>
            <div class="row ml-5 mr-0">
                <div class="col-md-9 col-12 mt-md-2 mt-5 mb-0 pb-0">
                    <a href="/"><img id="logoHeader" class="cursorHand" src="/img/caballo.png" title="Home"></a>
                    <img id="tituloHeader" src="/img/titulo.png">
                    <input id="inputHeader" class="ml-5" type="text"  placeholder="Buscar juguetes"><img id="lupaHeader" class="cursorHand" src="/img/lupa.png" alt="lupa" title="Buscar">
                </div>
                ...
                <div class="col-md-3 col-12 ml-4 ml-sm-5 ml-md-0 mt-4">
                    ...
                    <a href="usuarios/registro"><img class="cursorHand iconos ml-5" src="/img/icons/register.svg" id="registerHeader" alt="Registrarse" title="Registro"></a>
                    ...
                    <a href="{{url('usuario/perfil')}}"><img class="cursorHand iconos ml-5" src="/img/avatar.jpg" id="avatarHeader" alt="Perfil" title="Perfil"></a>
                </div>
