$(function () {
    pagina=2;
    //Si pulsamos el boton cargara más
$("#cargarMas").click(function (){
cargarMas();
});
//Rellena el desplegable con las diferentes categorias de la BDD
    $.ajax('/api/category/',
        {
            dataType: "json",
...
$("<option>  </option>").text(data[cont].name).attr("value", data[cont].id).appendTo($("#categoriasDesplegable"));
  ...
  //Si hemos cambiado el desplegable cargara mas
...
//Cargara mas dependiendo si hemos buscado algo en la barra de busqueda, hemos dado a cargar mas.
...
//Si hemos cambiado el desplegable cambiamos la sentencia
...
//Sentencia ajax la cual obtiene datos de la BDD dependiendo si hemos seleccioando una categoria, o hemos buscado un producto
        $.ajax(sentencia,
            {
                dataType: "json",
